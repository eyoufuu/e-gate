<?php
   ...
   $SQL = "select ip_inner,sum(upflow) as up,sum(downflow) as down,sum(upflow)+sum(downflow) as total from ". $tablename . " group by ip_inner order by total desc LIMIT $start , $limit ";
 //  echo $SQL;
