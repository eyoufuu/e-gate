...
jQuery("#ips_list").jqGrid({
    url:'keydata.php?nd='+new Date().getTime(),
	 editurl:'simple_tc_edit.php',
    datatype: "json",
	 colNames:['ID','时间','用户','ip','host', '关键字', '状态'],
    colModel:[
      ...
      {name:'host',index:'host', width:100, align:"right",editable:true,editrules:{required:true}},
   	{name:'keyword',index:'keyword', width:100, align:"right",editable:true,editrules:{required:true}},
...
<body>
  <strong>报表</strong> --> <strong>关键字</strong>       
