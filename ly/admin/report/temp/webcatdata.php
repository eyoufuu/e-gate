   ...
   switch($symbol)
    {
    	case "1":
    	    if ($systemmode == 0)
             $SQL = " call webip_all('$tablename',$dates,$datee,$start,$limit)";
    		
          else
             $SQL = " call webaccount_all('$tablename',$dates,$datee,$start,$limit)";
    		   
    		break;
    	case "2":
    	    
    		if ($systemmode == 0)
             $SQL = " call webip_id('$tablename',$dates,$datee,$accountid,$start,$limit)";
    		
          else
             $SQL = " call webaccount_id('$tablename',$dates,$datee,$accountid,$start,$limit)";
    	...
    	case "4":
			 if ($systemmode == 0)
              $SQL = " call webip_ips('$tablename',$dates,$datee,$ipsi,$ipei,$start,$limit)";   
    	  		
          else
             $SQL = " call webaccount_ips('$tablename',$dates,$datee,$ipsi,$ipei,$start,$limit)";   
