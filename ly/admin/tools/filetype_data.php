...
<?php
	...
	//$table = "file_transter";
 	 ...
 	 $SQL = "SELECT COUNT(*) AS count FROM file_transter where function='filetype'";
	...
	$SQL  = "SELECT * FROM  file_transter where function='filetype' order by $sidx $sord LIMIT $start,$limit";
