...
jQuery("#toolbar1").jqGrid({
   	 url:'blog_data.php?nd='+new Date().getTime(),
	 editurl:'blog_edit.php',
    datatype: "json",
   	colNames:['ID','博客名称','地址','阻挡'],
   	colModel:[
...
<table>
  <tr>
	  <td align ='left'><input  id="fileout" type="checkbox" <?php if($isfile['isblogopen'] == 1) echo "checked"; ?>  /></td>
	  <td>启用</td>
  </tr>
