...
jQuery("#toolbar1").jqGrid({
   	 url:'netdisk_data.php?nd='+new Date().getTime(),
	 editurl:'netdisk_edit.php',
    datatype: "json",
   	colNames:['ID','网盘名称','地址','阻挡'],
   	colModel:[
		...
		{//edit 
           ...
           closeAfterEdit: true,
		     afterShowForm:function ( ) {
				   ...
				   var tempfiletype="#"+ret.id+"netdisk";
...
<table>
   <tr>
	  <td align ='left'><input  id="fileout" type="checkbox" <?php if($isfile['isnetdiskopen'] == 1) echo "checked"; ?>  /></td>
	  <td>启用</td>
   </tr>
