...
<div class="bodyTitle">
  ...
  <div class="bodyTitleText">添加企业信息</div>
</div>
<br>
<form action="" method="post" name="form1" onSubmit="return notEmpty(categoryId, '请选择分类。')&&notEmpty(subject, '请输入标题。')">
  <table border="0" cellpadding="2" cellspacing="0">
    ...
    <tr>
      ...
      <td>
        <input name="subject" type="text" id="subject" size="70" maxlength="255">
      </td>
    </tr>
  </table>
...
<div class="bgFleet paddingAll">
  ...
  <tr>
    <td>顺序：</td>
    <td>
      <input name="order" type="text" id="order" value="100" maxlength="5">
      (越小越靠前)
    </td>
  </tr>
  <tr>
