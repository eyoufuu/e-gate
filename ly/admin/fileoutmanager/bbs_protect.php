...
jQuery("#toolbar1").jqGrid({
   	 url:'bbs_data.php?nd='+new Date().getTime(),
	 editurl:'bbs_edit.php',
    datatype: "json",
   	colNames:['ID','论坛名称','地址','阻挡'],
   	colModel:[
...
<table>
   <tr>
	  <td align ='left'><input  id="fileout" type="checkbox" <?php if($isfile['isbbsopen'] == 1) echo "checked"; ?>  /></td>
	  <td>启用</td>
   </tr>
